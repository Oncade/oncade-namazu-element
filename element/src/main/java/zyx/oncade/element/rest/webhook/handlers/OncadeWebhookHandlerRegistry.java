...
import zyx.oncade.element.rest.webhook.events.OncadeWebhookTestEvent;
...
public class OncadeWebhookHandlerRegistry {
    ...
    static {
        // Force class loading to ensure event registration for enums without dedicated handlers
        OncadeWebhookTestEvent.values();
    }
