package zyx.oncade.element.rest.examples.message;
...
import zyx.oncade.element.rest.examples.message.actions.CreateMessageRequest;
import zyx.oncade.element.rest.examples.message.actions.UpdateMessageRequest;
